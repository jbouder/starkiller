...
class GeminiProvider(BaseLLMProvider):
    """Google Gemini implementation for LLM operations."""
    ...
    async def generate_query(
        ...
        """Generate a query from natural language using Gemini."""
        system_instruction = """You are a data analyst assistant that converts natural language questions into PostgreSQL queries.
...
{instruction}"""
    ...
    async def recommend_visualization(
        ...
        """Recommend a visualization for query results using Gemini."""
        system_instruction = """You are a data visualization expert that recommends the best chart type for given data.
...
Recommend the best visualization for this data."""
    ...
    async def generate_react_visualization(
        ...
        """Generate React visualization code for a dashboard using Gemini."""
        system_instruction = """You are an expert React developer specializing in data visualization.
